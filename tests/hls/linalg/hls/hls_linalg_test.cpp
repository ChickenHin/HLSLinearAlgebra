...
class HLSLinalgTest : public ::testing::Test {
protected:
    void SetUp() override {}
    void TearDown() override {}
};

TEST_F(HLSLinalgTest, MatrixBasicOperations) {
    // Test basic matrix operations with double type for HLS compatibility
...
TEST_F(HLSLinalgTest, MatrixIdentity) {
...
TEST_F(HLSLinalgTest, MatrixArithmetic) {
...
TEST_F(HLSLinalgTest, VectorOperations) {
