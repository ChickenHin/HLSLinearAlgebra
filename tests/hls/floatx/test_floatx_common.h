...
// Declare the top-level functions to be tested
extern "C" {
    void floatx_add(double a, double b, double &result);
    void floatx_sub(double a, double b, double &result);
    void floatx_mul(double a, double b, double &result);
    void floatx_div(double a, double b, double &result);
}
